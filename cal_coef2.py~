...
class Iter_balance:
    ...
    def adjt(travsc, travs, P_is=[], A_js=[], tlr=0.01):
        ...
        # print(travs[0] != 0)
        # print("travs, ", travs)
        # print("P_is input, ", P_is)
        # print("A_js input, ", A_js,'\n')
        ...
        # print("P_isc before loop, ", P_isc, '\n')

        bflg = False    # bool flag for 'while' loop
        p = 0           # counting passes over travsc matrix
        # print("travsc init, ", travsc)

        while(bflg == False):
            #print("P_isc after ", p, "pass ", P_isc)
            #print("P_is after ",p, "pass ", P_is)
            #print("A_js after ",p, "pass ", A_js)
            #print("travsc after ",p, "pass ", travsc, '\n')
            ...
            for pih, pic in zip(P_is, P_isc):  #compute rows coeffs and store
                #print("p_ih before adj, ", pih)
                #print("p_ic before adj, ", pic)
...
#print("Future travels adjusted, ", gvalsradj_fin_it)
u_a, u_t = modopt(tca, tct, tda, tdt)
print("Utilities auto, ", u_a)
print("Utilities transit, ", u_t, '\n')
